...
public class PVPBattleLobbyService
{
    ...
    public PVPBattleLobbyService(IServiceScopeFactory serviceScopeFactory, PVPBattleSystemService battleSystemService, SessionService sessionService, ILogger<PVPBattleLobbyService> logger)
    {
        _serviceScope = serviceScopeFactory.CreateScope();
        _battleSystemService = battleSystemService;
        _playerManager = _serviceScope.ServiceProvider.GetService<PlayerManager> ();
